...
Codrive 每分钟还会进行一次范围很小的自动恢复检查：发送正在等待对话空闲的任务消息，恢复长时间没有结果的 AI 工作；如果运行中的项目仍有未开始任务，但当前完全没有 Codex 工作，则重新启动任务选择。任务正在执行、正在选择、正在进行产品验收、正在等待用户回答，或者 Codex 已经判断剩余任务应等待当前工作时，都不会重复询问 AI。
