export const boardStyles = `
  ...
  * { box-sizing: border-box; }
  ...
  .brand, .local-status, .sidebar-heading, .project-list, .archived-projects, .sidebar-footer { position: relative; z-index: 1; }
  ...
  .project-list { display: grid; min-height: 0; flex: 1; align-content: start; gap: 5px; margin: 0 -4px; padding: 0 4px 18px; overflow-y: auto; }
  ...
  .archived-projects { margin: 0 0 10px; border-top: 1px solid rgba(255,255,255,.1); border-bottom: 1px solid rgba(255,255,255,.1); }
  .archived-projects-trigger { display: grid; grid-template-columns: minmax(0,1fr) auto; gap: 10px; align-items: center; width: 100%; padding: 11px 8px; color: rgba(255,255,255,.72); background: transparent; border: 0; cursor: pointer; text-align: left; }
  .archived-projects-trigger:hover { color: white; }
  .archived-projects-trigger b, .archived-projects-trigger small { display: block; }
  .archived-projects-trigger b { font-size: 11px; }
  .archived-projects-trigger small { margin-top: 3px; color: rgba(255,255,255,.38); font-size: 8px; }
  .archived-projects-trigger strong { display: grid; min-width: 24px; height: 22px; place-items: center; padding: 0 6px; background: rgba(255,255,255,.08); border-radius: 8px; font-size: 10px; }
  .archived-projects-trigger[aria-expanded="true"] strong { color: var(--sidebar-deep); background: #c8d2cb; }
  .archived-projects-panel { max-height: min(32vh, 250px); padding: 0 0 9px; overflow-y: auto; }
  #archived-project-list { display: grid; gap: 6px; }
  .archived-project-row { display: grid; grid-template-columns: minmax(0,1fr) auto; gap: 6px; align-items: center; padding: 8px; background: rgba(255,255,255,.045); border-radius: 9px; }
  .archived-project-link { min-width: 0; color: rgba(255,255,255,.72); text-decoration: none; }
  .archived-project-link b, .archived-project-link small { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  .archived-project-link b { font-size: 11px; }
  .archived-project-link small { margin-top: 4px; color: rgba(255,255,255,.38); font-size: 8px; }
  .archived-project-restore { min-height: 29px; padding: 0 9px; color: #d9eee5; background: transparent; border: 1px solid rgba(112,214,178,.28); border-radius: 8px; cursor: pointer; font-size: 9px; font-weight: 800; }
  .archived-project-restore:hover { color: #09251b; background: var(--mint); }
  .archived-empty { padding: 9px 8px 12px; color: rgba(255,255,255,.38); font-size: 9px; }
  .archived-projects-status { min-height: 13px; margin: 6px 8px 2px; color: #f3ae9e; font-size: 9px; line-height: 1.45; }
  ...
  .workspace-header { padding: 20px 28px 16px; background: rgba(255,255,255,.82); border-bottom: 1px solid var(--line); backdrop-filter: blur(14px); }
  ...
  .project-controls { flex: none; }
  .project-actions { display: flex; gap: 7px; }
  .project-action-status { max-width: 330px; margin-top: 6px; color: #a13d2f; font-size: 9px; font-weight: 700; text-align: right; }
  ...
  .task-action-status { color: #a13d2f; font-size: 11px; line-height: 1.5; }
  .task-action-status:empty { display: none; }
  ...
  .project-action-status:empty { display: none; }
  .project-stats { display: flex; gap: 22px; align-items: flex-end; margin: 14px 0 0 24px; }
  ...
  .board-wrap { min-height: 0; overflow: auto; }
  .board {
    display: grid;
    grid-template-columns: repeat(var(--column-count, 7), minmax(252px, 1fr));
    gap: 12px;
    min-width: calc(var(--column-count, 7) * 252px);
    min-height: 100%;
  ...
  .detail-head strong { flex-shrink: 0; font-size: 12px; }
  .detail-head > .icon-button { flex-shrink: 0; margin-left: 12px; }
  .detail-heading { display: flex; min-width: 0; gap: 8px; align-items: center; }
  .detail-heading > span { flex-shrink: 0; color: #9aa19d; }
  .detail-milestone-link { min-width: 0; padding: 4px 0; overflow: hidden; color: #567261; background: transparent; border: 0; cursor: pointer; font-size: 11px; text-decoration: underline; text-decoration-color: #b7c6ba; text-underline-offset: 3px; text-overflow: ellipsis; white-space: nowrap; }
  .detail-milestone-link:hover { color: #a94628; text-decoration-color: currentColor; }
  ...
  .integration-card { display: grid; grid-template-columns: minmax(0,1fr) auto; gap: 24px; align-items: center; max-width: 980px; margin: 0 auto 14px; padding: 22px 26px; color: #e9f4ee; background: radial-gradient(circle at 88% 20%, rgba(87,199,151,.23), transparent 32%), #183129; border: 1px solid #294d40; border-radius: 14px; box-shadow: 0 10px 28px rgba(16,38,30,.12); animation: column-arrive .4s .03s both; }
  .integration-card h2 { margin: 5px 0 7px; font: 600 24px/1.05 var(--display); letter-spacing: -.025em; }
  .integration-card p { max-width: 650px; margin: 0; color: rgba(236,246,241,.62); font-size: 11px; line-height: 1.55; }
  .integration-kicker { color: #77d7ae; font: 900 9px/1 var(--condensed); letter-spacing: .16em; text-transform: uppercase; }
  .integration-missing, .integration-toggle { display: flex; gap: 12px; align-items: center; }
  .integration-missing b, .integration-toggle b { color: #aebbb5; font-size: 10px; }
  .integration-missing a { padding: 10px 13px; color: #15382b; background: #79d7af; border-radius: 9px; font-size: 10px; font-weight: 900; text-decoration: none; }
  .integration-toggle { position: relative; cursor: pointer; }
  .integration-toggle span { text-align: right; }
  .integration-toggle b, .integration-toggle small { display: block; }
  .integration-toggle b { color: #82ddb6; }
  .integration-toggle small { margin-top: 3px; color: rgba(236,246,241,.55); font-size: 9px; }
  .integration-toggle input { position: absolute; opacity: 0; pointer-events: none; }
  .integration-toggle i { position: relative; width: 42px; height: 24px; background: #426257; border-radius: 999px; transition: background .2s ease; }
  .integration-toggle i::after { position: absolute; top: 3px; left: 3px; width: 18px; height: 18px; content: ""; background: #f5f9f6; border-radius: 50%; box-shadow: 0 2px 7px rgba(0,0,0,.2); transition: transform .2s ease; }
  .integration-toggle input:checked + i { background: #4fbd8e; }
  .integration-toggle input:checked + i::after { transform: translateX(18px); }
  .integration-toggle input:focus-visible + i { outline: 3px solid rgba(121,215,175,.35); outline-offset: 3px; }
  ...
  .product-hero-actions { display: flex; gap: 8px; align-items: center; }
  ...
  .archive-notice { display: flex; justify-content: space-between; gap: 22px; color: #e5eee9; background: radial-gradient(circle at 94% 0, rgba(112,214,178,.18), transparent 38%), #1b2d26; border-color: #30483e; }
  .archive-notice span { color: var(--mint); font: 900 9px/1 var(--condensed); letter-spacing: .14em; text-transform: uppercase; }
  .archive-notice h2 { margin: 8px 0 7px; font: 600 24px/1.1 var(--display); }
  .archive-notice p { max-width: 680px; margin: 0; color: rgba(255,255,255,.62); font-size: 11px; line-height: 1.65; }
  .archive-notice time { flex: none; color: rgba(255,255,255,.46); font-size: 9px; }
  ...
  .archive-backdrop, .update-backdrop { position: fixed; z-index: 80; inset: 0; display: grid; place-items: center; padding: 22px; background: rgba(8,21,16,.72); backdrop-filter: blur(9px); }
  .archive-panel { display: grid; grid-template-columns: 64px minmax(0,1fr); gap: 22px; width: min(570px, 100%); padding: 30px; background: linear-gradient(145deg, #fff 0%, #edf1ea 100%); border: 1px solid rgba(255,255,255,.72); border-radius: 20px; box-shadow: 0 32px 100px rgba(0,0,0,.34); animation: modal-arrive .28s both; }
  .archive-panel:focus { outline: none; }
  .archive-symbol { display: grid; width: 64px; height: 64px; place-items: center; color: #f7f2e8; background: #293b34; border-radius: 19px 19px 19px 5px; font: 700 35px/1 var(--display); transform: rotate(-3deg); }
  .archive-kicker { color: #607069; font: 900 9px/1 var(--condensed); letter-spacing: .16em; }
  .archive-panel h2 { margin: 8px 0 10px; font: 600 36px/1 var(--display); letter-spacing: -.04em; }
  .archive-panel p { margin: 0; color: #56615b; font-size: 12px; line-height: 1.7; }
  .archive-status { min-height: 20px; padding-top: 10px; color: #9d3428 !important; font-weight: 700; }
  .archive-actions { display: flex; gap: 8px; margin-top: 17px; }
  ...
  @media (max-width: 760px) {
    ...
    .project-controls { display: flex; width: 100%; gap: 10px; align-items: center; }
    .project-actions { position: static; flex: none; }
    .project-action-status { min-width: 0; flex: 1; max-width: none; margin-top: 0; line-height: 1.35; text-align: left; }
    .project-stats { flex-wrap: wrap; gap: 12px; margin: 12px 0 0; }
    .board { grid-template-columns: repeat(var(--column-count, 7), minmax(82vw, 1fr)); min-width: calc(var(--column-count, 7) * 82vw); padding: 14px 14px 30px; scroll-snap-type: x proximity; }
    ...
    .archive-backdrop { align-items: end; padding: 8px; }
    .archive-panel { grid-template-columns: 46px minmax(0,1fr); gap: 15px; padding: 24px 19px; border-radius: 18px; }
    .archive-symbol { width: 46px; height: 46px; border-radius: 14px 14px 14px 4px; font-size: 26px; }
    .archive-panel h2 { font-size: 31px; }
    ...
    .integration-card { grid-template-columns: 1fr; align-items: start; padding: 20px; }
    .integration-toggle span { text-align: left; }
  ...
  .board-workspace { display: flex; min-width: 0; flex-direction: column; }
  .board-workspace .workspace-header { flex-shrink: 0; }
  .board-workspace .board-wrap { flex: 1; min-height: 0; height: auto; }
  .workspace-tabs { display: flex; flex-shrink: 0; gap: 22px; padding: 0 28px; background: rgba(255,255,255,.82); border-bottom: 1px solid var(--line); }
  .workspace-tabs button { padding: 13px 2px 11px; border: 0; border-bottom: 2px solid transparent; color: var(--muted); background: transparent; cursor: pointer; font-size: 12px; font-weight: 700; }
  .workspace-tabs button[aria-current="page"] { color: var(--ink); border-bottom-color: var(--signal); }
  .milestone-filters { display: flex; align-items: center; gap: 14px; flex-shrink: 0; min-width: 0; padding: 14px 28px; border-bottom: 1px solid var(--line); background: var(--surface-soft); }
  .milestone-filter-options { display: flex; flex: 1; min-width: 0; gap: 10px; overflow-x: auto; padding: 3px; margin: -3px; }
  ...
  .milestone-filter { min-width: 0; padding: 0; color: var(--ink); background: transparent; border: 0; cursor: pointer; text-align: left; font-size: 13px; }
  .milestone-filter strong { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  .milestone-filter::after { position: absolute; inset: 0; border-radius: 10px; content: ""; }
  .milestone-filter:focus-visible { outline: none; }
  .milestone-filter:focus-visible::after { outline: 2px solid var(--signal); outline-offset: 2px; }
  .milestone-filter-heading .milestone-state { margin-left: auto; }
  .milestone-detail-link { position: relative; z-index: 1; flex-shrink: 0; padding: 3px 0; color: #547561; background: transparent; border: 0; cursor: pointer; font-size: 11px; text-decoration: underline; text-underline-offset: 3px; }
  .milestone-detail-link:hover { color: #a94628; }
  .milestone-filter-card[data-state="decision"] { border-left: 3px solid var(--amber); }
  .milestone-filter-card[data-state="decision"] .milestone-state, .milestone-filter-card[data-state="decision"] .milestone-excerpt { color: #976127; }
  .milestone-heading { display: flex; min-width: 0; gap: 14px; align-items: baseline; justify-content: space-between; }
  .milestone-heading strong { min-width: 0; overflow: hidden; color: var(--ink); font-size: 13px; font-weight: 700; text-overflow: ellipsis; white-space: nowrap; }
  .milestone-state { flex-shrink: 0; color: #547561; font-size: 10px; }
  [data-state="decision"] > .milestone-heading .milestone-state { color: #976127; }
  .milestone-excerpt { display: block; min-width: 0; margin-top: 7px; overflow: hidden; color: var(--muted); font-size: 11px; line-height: 1.55; text-overflow: ellipsis; white-space: nowrap; }
  .milestone-list { flex: 1; min-height: 0; overflow-y: auto; padding: 18px 28px 34px; }
  .milestone-status-filters { display: flex; gap: 6px; margin-bottom: 18px; }
  .milestone-status-filters button { min-height: 32px; padding: 7px 12px; color: var(--muted); background: transparent; border: 1px solid transparent; border-radius: 8px; cursor: pointer; font-size: 11px; }
  .milestone-status-filters button[aria-pressed="true"] { color: #234331; background: #e8eee8; border-color: #ccd8cd; font-weight: 700; }
  .milestone-rows { display: grid; gap: 10px; max-width: 1120px; }
  .milestone-row { position: relative; display: block; width: 100%; min-width: 0; padding: 19px 46px 17px 20px; text-align: left; border: 1px solid var(--line); border-radius: 12px; background: rgba(255,255,255,.93); cursor: pointer; transition: border-color .15s ease, box-shadow .15s ease; }
  .milestone-row:hover { border-color: #aebcaf; box-shadow: 0 5px 18px rgba(18,31,26,.055); }
  .milestone-row .milestone-heading strong { font-size: 15px; }
  .milestone-row[data-state="decision"] { border-left: 3px solid var(--amber); }
  .milestone-row[data-state="done"] .milestone-state { color: #28725b; }
  .milestone-task-count { display: block; margin-top: 12px; color: #829087; font-size: 10px; }
  .milestone-row-arrow { position: absolute; right: 20px; top: 50%; color: #829087; transform: translateY(-50%); }
  .milestone-empty { margin: 0; padding: 30px 20px; color: var(--muted); background: rgba(255,255,255,.64); border: 1px dashed var(--line-strong); border-radius: 12px; font-size: 12px; line-height: 1.6; }
  .milestone-task-row { display: flex; gap: 12px; align-items: center; justify-content: space-between; width: 100%; margin-top: 8px; padding: 12px; border: 1px solid var(--line); border-radius: 9px; background: var(--surface-soft); cursor: pointer; text-align: left; }
  .milestone-task-row:hover { border-color: #aebcaf; background: #edf2ea; }
  .milestone-task-row span { min-width: 0; color: var(--ink); font-size: 12px; line-height: 1.5; overflow-wrap: anywhere; }
  .milestone-task-row small { flex-shrink: 0; color: var(--muted); font-size: 10px; }
  .milestone-detail { overflow-wrap: anywhere; }
  .milestone-detail[data-state="done"] .detail-status { color: #28725b; }
  .milestone-detail[data-state="decision"] .detail-status { color: #976127; }
  .milestone-question { margin: 14px 0 0; padding: 12px 14px; border: 1px solid #e7d7b7; border-radius: 9px; background: #fff8e7; font-size: 12px; line-height: 1.65; white-space: pre-wrap; }
  ...
  .task-card .task-milestone { display: block; margin: 8px 0 0; color: #647d6c; font-size: 10px; font-weight: 700; }
  ...
  @media (max-width: 760px) {
    ...
    .milestone-filters { padding: 12px 16px; }
    .milestone-list { padding: 16px 16px 30px; }
    .milestone-row { padding-left: 16px; }
  }
`;
